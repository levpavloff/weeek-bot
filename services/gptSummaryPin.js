...
async function summaryMessage(prompt) {
    ...
    Твоя задача - выдавать ровно одно короткое предложение. Я буду присылать тебе текст телеграм-сообщения и его автора. Нужно уместить смысл сообщения в одно краткое предложение. Постарайся переводить имя автора на русский язык. 
  `;
