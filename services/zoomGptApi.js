...
1. Обязательные параметры:
   ...
   - Дата и время в разных форматах. Тебе нужно просто вытащить ее из общего текста и положить в JSON переведенным на английский язык. Даже если это "Завтра в 11 утра" или 24 июня в 21 вечера - пиши прямо так в объект.  
